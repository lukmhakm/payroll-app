                    ...
                    return (
                        ...
                        >
                            <button
                                ...
                                type="button"
                                className="w-full text-left cursor-pointer px-6 py-5 flex items-center justify-between bg-[var(--theme-primary)] border-none outline-none group"
                            >
                                <div>
                                    <h5 className="text-[var(--theme-surface)] text-3xl font-black uppercase tracking-tight leading-none transition-colors group-hover:text-[var(--theme-accent)]">
                                        {monthYear}
                                    </h5>
                                ...
                                <span
                                    className="w-8 h-8 rounded-full bg-[var(--theme-surface)] text-[var(--theme-primary)] flex items-center justify-center font-bold text-sm shrink-0 transition-transform duration-300"
